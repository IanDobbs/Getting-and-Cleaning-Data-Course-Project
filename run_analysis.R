...
test_set <- read.table("~/Rstudio_projects/datasciencecoursera/Getting-and-Cleaning-Data-Course-Project/UCI HAR Dataset/test/X_test.txt") ## results data
test_labels <- read.table("~/Rstudio_projects/datasciencecoursera/Getting-and-Cleaning-Data-Course-Project/UCI HAR Dataset/test/y_test.txt") ## activity names 1-6
...
train_subject <- read.table("~/Rstudio_projects/datasciencecoursera/Getting-and-Cleaning-Data-Course-Project/UCI HAR Dataset/train/subject_train.txt")
train_set <- read.table("~/Rstudio_projects/datasciencecoursera/Getting-and-Cleaning-Data-Course-Project/UCI HAR Dataset/train/X_train.txt")
train_labels <- read.table("~/Rstudio_projects/datasciencecoursera/Getting-and-Cleaning-Data-Course-Project/UCI HAR Dataset/train/y_train.txt")
